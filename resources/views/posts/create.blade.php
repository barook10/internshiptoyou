<x-layout>
    ...
    <section class="container px-4 py-5 mt-5">
        ...
        <main class="max-w-lg mx-auto bg-light border border-secondary p-4 rounded">
            ...
            <h1 class="text-center font-weight-bold text-xl">Create Post!</h1>

            <form method="POST" action="/create" class="mt-4" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="salary" id="salary" class="form-control" required value="{{ old('salary') }}">
                    @error('salary')
                    <p class="text-danger text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    <button type="submit" class="btn btn-primary bg-white text-dark">Publish</button>
                </div>
